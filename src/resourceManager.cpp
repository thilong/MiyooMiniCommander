    ...
    m_font(NULL)
{
    ...
    m_surfaces[T_SURFACE_CURSOR1] = SDL_utils::createImage(318, LINE_HEIGHT, SDL_MapRGB(Globals::g_screen->format, COLOR_CURSOR_1));
    m_surfaces[T_SURFACE_CURSOR2] = SDL_utils::createImage(318, LINE_HEIGHT, SDL_MapRGB(Globals::g_screen->format, COLOR_CURSOR_2));
    // Load font
    m_font = SDL_utils::loadFont(RESDIR "/Fiery_Turk.ttf", 16);
}
